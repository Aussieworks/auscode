local settings = {
    ...
    loggingHistoryLength = {value = 10000, default = 10000}, -- Maximum number of logs to keep in history, 0 means no limit (10000 is around 30 seconds of logs at 60 TPS)
